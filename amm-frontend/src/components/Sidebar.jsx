...
function Sidebar({ closeSidebar }) {
    ...
    return (
        <>
            <div
                id="default-sidebar"
                className="bg-neutral-900 p-4 sm:p-6 w-full h-full"
                aria-label="Sidebar"
            >
                <div className="h-full rounded-xl shadow-lg px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-neutral-800 flex flex-col">
                    {/* Role Badge */}
